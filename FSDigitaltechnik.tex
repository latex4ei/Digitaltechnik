...
\documentclass[ngerman, threecolumn]{latex4ei/latex4ei_sheet}
...
\titlespacing*{\subsection}{1pt}{1pt}{2pt}
\titlespacing*{\subsubsection}{1.5pt}{.5pt}{1pt}
...
%=======================================================================
\maketitle
\fancyfoot[C]{von Emanuel Regnath (\href{mailto:emanuel.regnath@tum.de}{emanuel.regnath@tum.de}), Martin Zellner (\href{mailto:martin.zellner@mytum.de}{martin.zellner@mytum.de}), Hendrik Böttcher (\href{mailto:hendrik.boettcher@tum.de}{hendrik.boettcher@tum.de})}
% ======================================================================
