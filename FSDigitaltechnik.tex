...
\section{Boolsche Algebra}
	...
	\begin{tabular}{l|l}
		Gesetz & Boolesche Algebra                                        \\
		            & $({0,1};\cdot , +, \overline{x})$                        \\ \hline
		...
		Resolution (allgemein)   & $x\cdot a + \overline{x} \cdot b = x \cdot a + \overline{x} \cdot b + a \cdot b$  \\
		            &  $(x + a) \cdot (\overline{x} + b) = (x + a) \cdot (\overline{x} + b) \cdot (a + b)$ \\ 
		Resolution (speziell)   & $x\cdot a + \overline{x} \cdot a = a$  \\
		            &  $(x + a) \cdot (\overline{x} + a) = a$  
	\end{tabular}
